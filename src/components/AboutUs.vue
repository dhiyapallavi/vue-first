      ...
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="150">
            ...
            <ul>
              <li>
                <i class="ri-check-double-line"></i> We started with a simple idea: do what is best for the client.
              </li>
              <li>
                <i class="ri-check-double-line"></i> Our methodical and individual approach to each project delivers the finest possible results for your media.
              </li>
              <li>
                <i class="ri-check-double-line"></i> Our day-to-day work is to solve your problems utilising the most up-to-date, practical adaptive technology, and we have a lot of fun doing it.
              </li>
            </ul>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0" data-aos="fade-up" data-aos-delay="300">
            ...
            <router-link to="/services" class="btn-learn-more">Learn More</router-link>
          </div>
        </div>
      </div>
    </section>
